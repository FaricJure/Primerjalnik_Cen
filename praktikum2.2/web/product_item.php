    ...
    <div class="product">
        ...
        <div class="product-body">
            ...
            <h3 class="product-name"><a
                        href="product.php?name=<?php echo $product['productName'] ?>&id=<?php echo $product['productId'] ?>&store=<?php echo $product['sotreName'] ?>"><?php echo $product['productName'] ?></a>
            </h3>
            ...
            <div class="product-btns">
                <button class="add-to-wishlist" type="submit" name="pid" value="<?php echo $product['productId'] ?>" ><i
