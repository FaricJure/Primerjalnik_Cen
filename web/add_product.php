...
if (isset($_POST['product-submit'])) {
    ...
    $insertProduct = $conn->prepare("INSERT INTO product(name,price,barcode,image_url,category_id,description,subcategory_id,update_time,img) VALUES (?,?,?,?,?,?,?,?,?)");
    $insertProduct->execute([$productName, $price, $barcode, $image, $categoryId, $description, $subcategory,'CURRENT_TIMESTAMP',$image2]);
